...
/* SENSITIVITY */
#define GYRO_SENSITIVITY (double)2621440.0  // LSB/°/sec
#define ACCL_SENSITIVITY (double)26756268.0 // LSB/m/sec^2

/* 重力加速度 */
#define G_ACCL 9.7803267714
...
/* MSC_CRTL Bit0    data ready bit=0, meaning that data collection must start on the rising edges of the DR pulses.  */
